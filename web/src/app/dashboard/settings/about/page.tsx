...
import { ChevronLeft, Boxes, Users, Zap, Globe } from 'lucide-react';
...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto space-y-8 py-6">
      ...
      <section className="surface-card rounded-2xl border border-stroke p-8 space-y-8 text-sm leading-relaxed text-muted">
        <div className="text-center space-y-4">
          <div className="mx-auto grid h-20 w-20 place-items-center rounded-3xl bg-ink text-white shadow-2xl">
            <Boxes size={40} />
          </div>
          <div>
            <h2 className="text-2xl font-black text-ink">Estokar Inventory OS</h2>
            <p className="text-accent font-bold">Versão 1.0.4</p>
          </div>
