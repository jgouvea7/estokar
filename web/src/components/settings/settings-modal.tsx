...
export function SettingsModal({ isOpen, onClose, theme, onThemeChange, onOpenVersionModal }: SettingsModalProps) {
            ...
            {activeSettingsTab === 'legal' ? (
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <LegalLink href="/settings/terms" icon={FileText} label="Termos de uso" onClick={onClose} />
                  <LegalLink href="/settings/privacy" icon={Shield} label="Privacidade" onClick={onClose} />
                  <LegalLink href="/settings/about" icon={Info} label="Sobre o sistema" onClick={onClose} />
                  <button
                    type="button"
